...
import type { WaAnimatedImage } from "_bundle_/src/components/animated-image/animated-image.js";
import type { WaAnimation } from "_bundle_/src/components/animation/animation.js";
import type { WaAvatar } from "_bundle_/src/components/avatar/avatar.js";
import type { WaBreadcrumb } from "_bundle_/src/components/breadcrumb/breadcrumb.js";
import type { WaBreadcrumbItem } from "_bundle_/src/components/breadcrumb-item/breadcrumb-item.js";
import type { WaButton } from "_bundle_/src/components/button/button.js";
import type { WaButtonGroup } from "_bundle_/src/components/button-group/button-group.js";
import type { WaBadge } from "_bundle_/src/components/badge/badge.js";
import type { WaCallout } from "_bundle_/src/components/callout/callout.js";
import type { WaCard } from "_bundle_/src/components/card/card.js";
import type { WaCarousel } from "_bundle_/src/components/carousel/carousel.js";
import type { WaCarouselItem } from "_bundle_/src/components/carousel-item/carousel-item.js";
import type { WaCheckbox } from "_bundle_/src/components/checkbox/checkbox.js";
import type { WaColorPicker } from "_bundle_/src/components/color-picker/color-picker.js";
import type { WaComparison } from "_bundle_/src/components/comparison/comparison.js";
import type { WaCopyButton } from "_bundle_/src/components/copy-button/copy-button.js";
import type { WaDetails } from "_bundle_/src/components/details/details.js";
import type { WaDialog } from "_bundle_/src/components/dialog/dialog.js";
import type { WaDivider } from "_bundle_/src/components/divider/divider.js";
import type { WaDrawer } from "_bundle_/src/components/drawer/drawer.js";
import type { WaDropdown } from "_bundle_/src/components/dropdown/dropdown.js";
import type { WaDropdownItem } from "_bundle_/src/components/dropdown-item/dropdown-item.js";
import type { WaFormatBytes } from "_bundle_/src/components/format-bytes/format-bytes.js";
import type { WaFormatDate } from "_bundle_/src/components/format-date/format-date.js";
import type { WaFormatNumber } from "_bundle_/src/components/format-number/format-number.js";
import type { WaIcon } from "_bundle_/src/components/icon/icon.js";
import type { WaInclude } from "_bundle_/src/components/include/include.js";
import type { WaInput } from "_bundle_/src/components/input/input.js";
import type { WaMutationObserver } from "_bundle_/src/components/mutation-observer/mutation-observer.js";
import type { WaOption } from "_bundle_/src/components/option/option.js";
import type { WaPage } from "_bundle_/src/components/page/page.js";
import type { WaPopover } from "_bundle_/src/components/popover/popover.js";
import type { WaPopup } from "_bundle_/src/components/popup/popup.js";
import type { WaProgressBar } from "_bundle_/src/components/progress-bar/progress-bar.js";
import type { WaProgressRing } from "_bundle_/src/components/progress-ring/progress-ring.js";
import type { WaQrCode } from "_bundle_/src/components/qr-code/qr-code.js";
import type { WaRadio } from "_bundle_/src/components/radio/radio.js";
import type { WaRadioGroup } from "_bundle_/src/components/radio-group/radio-group.js";
import type { WaRating } from "_bundle_/src/components/rating/rating.js";
import type { WaRelativeTime } from "_bundle_/src/components/relative-time/relative-time.js";
import type { WaResizeObserver } from "_bundle_/src/components/resize-observer/resize-observer.js";
import type { WaScroller } from "_bundle_/src/components/scroller/scroller.js";
import type { WaSelect } from "_bundle_/src/components/select/select.js";
import type { WaSkeleton } from "_bundle_/src/components/skeleton/skeleton.js";
import type { WaSlider } from "_bundle_/src/components/slider/slider.js";
import type { WaSpinner } from "_bundle_/src/components/spinner/spinner.js";
import type { WaSplitPanel } from "_bundle_/src/components/split-panel/split-panel.js";
import type { WaSwitch } from "_bundle_/src/components/switch/switch.js";
import type { WaTab } from "_bundle_/src/components/tab/tab.js";
import type { WaTabGroup } from "_bundle_/src/components/tab-group/tab-group.js";
import type { WaTabPanel } from "_bundle_/src/components/tab-panel/tab-panel.js";
import type { WaTag } from "_bundle_/src/components/tag/tag.js";
import type { WaTextarea } from "_bundle_/src/components/textarea/textarea.js";
import type { WaTooltip } from "_bundle_/src/components/tooltip/tooltip.js";
import type { WaTree } from "_bundle_/src/components/tree/tree.js";
import type { WaTreeItem } from "_bundle_/src/components/tree-item/tree-item.js";
import type { WaZoomableFrame } from "_bundle_/src/components/zoomable-frame/zoomable-frame.js";
